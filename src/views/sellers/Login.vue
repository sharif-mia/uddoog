          ...
          <div class="col-7">
            ...
            <form @submit.prevent="login">
              ...
              <div class="form-group d-flex justify-content-between">
                ...
                <router-link class="btn-link" :to="{ name: 'forgotPassword' }">Forgot password?</router-link>
              </div>
              
              <div class="form-group">
                <button type="submit" class="btn btn-full justify-center py-3" :disabled="!password && !email">Login</button>
              </div>
            </form>
